...
(blue = positive, red = negative), each with its own legend — this clean solution
happens to have no negative edges, so only blue appears here. Pass
`direction = "horizontal"` for a left-to-right layout. The
