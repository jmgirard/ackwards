...
> **M39**. The epic is now M31–M39. **M38 shipped** — its section was removed from this file per the
> maintenance rule; see its `MILESTONES.md` entry. **M39 is the only pending milestone left.**
