...
* **Plain-English documentation.** The README, the package description, and
  ...
  first used. The vignettes are unchanged. No function, argument, default, or
...
* **Plain-English vignettes, first batch.** The introduction, the choosing-k
  ...
  results they show did not change, and a check in the development workflow
  now proves that for every vignette source.
