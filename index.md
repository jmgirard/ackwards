...
We use the 25-item Big Five Inventory
([`psych::bfi`](https://rdrr.io/pkg/psych/man/bfi.html)) as a running
...
runs parallel analysis and Velicer’s MAP criterion to help you choose an
upper bound for the hierarchy depth.
...
fits factor models at every level from 1 to k and computes the
