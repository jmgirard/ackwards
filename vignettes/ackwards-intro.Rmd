...
come with a legend. Primary-parent edges are always positive after sign
alignment, so a red arrow marks a genuine secondary relationship. For a
left-to-right layout (handy for wide slides), pass `direction = "horizontal"`.
