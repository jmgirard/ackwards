...
No single criterion is decisive — look at where they converge. k in `ackwards()`
is an *upper bound*; setting k one or two levels above the consensus to watch
factors fragment is intentional and informative. For a full explanation of each
