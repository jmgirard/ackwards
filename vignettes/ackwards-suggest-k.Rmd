...
between observed and comparison-data eigenvalues at each k. Lower is better;
the starred k is where adding another factor no longer reduces RMSE beyond
chance. Requires `EFAtools`.
