...
| CD | Conservative, accurate | Ordinal/non-normal data | `EFAtools` |
...
The BFI has 25 items measuring five personality traits. The consensus from five
criteria is tight:
...
PA-PC says retain up to k = 6 (the upper bound, predictably the highest). PA-FA
says k = 5. MAP and VSS-1/2 suggest 4–5. If CD was available in your
environment, it would likely come in near 5 as well.

**Defensible choice: `k = 6`.** Setting k one level above the PA-FA consensus
(5) lets `ackwards()` show us whether a sixth level fragments the Big Five into
stable sub-facets or produces artifactual micro-factors — a useful diagnostic.
