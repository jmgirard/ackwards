...
```{r ggplot-check, echo = FALSE, results = "asis"}
if (!has_ggplot2) {
  cat(
    "> **Note:** The correlation-comparison chart below requires the",
    "**ggplot2** package, which is not currently installed. Install it with",
    "`install.packages(\"ggplot2\")` to render it.\n"
  )
}
```
