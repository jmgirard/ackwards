...
cleaner layouts for deep hierarchies. Also clears an error in the
package’s own test suite that appeared on one of CRAN’s macOS check
flavours after 0.1.1 was published.
