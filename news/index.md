...
- New vignette
  ...
  — “Choosing k: How Many Factors?” — a narrative/educational companion
  to the
  [`suggest_k()`](https://jmgirard.github.io/ackwards/reference/suggest_k.md)
  reference page. Covers all five criteria with pros/cons and bias
  direction, engine-to- criterion pairing (PA-FA for efa/esem; PA-PC for
  pca), all four arguments including the ordinal→Pearson caveat and the
  PA non-reproducibility note, and a worked k-selection for the BFI.
  Listed first in the pkgdown “Deep dives” section. (#M14)

- Intro vignette
  ([`vignette("ackwards-intro")`](https://jmgirard.github.io/ackwards/articles/ackwards-intro.md))
  Step 1 trimmed to the default
  [`suggest_k()`](https://jmgirard.github.io/ackwards/reference/suggest_k.md)
  call plus a pointer to the new vignette; criteria prose moved there.
  (#M14)

- README corrected:
  [`suggest_k()`](https://jmgirard.github.io/ackwards/reference/suggest_k.md)
  description updated from “parallel analysis and Velicer’s MAP
