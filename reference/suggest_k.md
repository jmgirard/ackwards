...
#> ✔ Running parallel analysis (20 iterations, PC + FA)... [180ms]
#> 
#> ℹ Running MAP and VSS...
#> ✔ Running MAP and VSS... [60ms]
#> 
#> ℹ Running Comparison Data (CD)...
#> ✔ Running Comparison Data (CD)... [2.5s]
#> 
sk
#> 
...
#> ✔ Running parallel analysis (5 iterations, PC + FA)... [59ms]
#> 
#> 
#> ── Factor / Component Count Suggestion (ackwards) ──────────────────────────────
#> Variables: 16
...
#> 
#> ℹ Running Comparison Data (CD)...
#> ✔ Running Comparison Data (CD)... [2.6s]
#> 
#> 
#> ── Factor / Component Count Suggestion (ackwards) ──────────────────────────────
#> Variables: 16
...
#> ℹ Running parallel analysis (20 iterations, PC + FA)...
#> ✔ Running parallel analysis (20 iterations, PC + FA)... [141ms]
#> 
#> ℹ Running MAP and VSS...
#> ✔ Running MAP and VSS... [60ms]
#> 
