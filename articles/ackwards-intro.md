...
#> ✔ Running parallel analysis (20 iterations, PC + FA)... [244ms]
#> 
...
> a cosmetic default. The reason is not numerical: the `W′RW`
...
> into the between-level edges — confounding the within-versus-between
> question the method exists to answer. That confound is why oblique
> rotations are deliberately not offered. Varimax is the orthogonal
> rotation Goldberg (2006) used, and it is the same rotation as the
> “CF-VARIMAX” reported by Mplus-based papers such as Kim & Eaton (2015)
