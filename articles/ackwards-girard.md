...
#> ✔ Running parallel analysis (20 iterations, PC + FA)... [99ms]
#> 
#> ℹ Running MAP and VSS...
#> ✔ Running MAP and VSS... [62ms]
#> 
#> ℹ Running Comparison Data (CD)...
#> ✔ Running Comparison Data (CD)... [3.5s]
#> 
print(sk)
#> 
...
#> ✔ Fitting 10 split-half replicates (pca, k = 1-7)... [253ms]
#> 
print(cmp)
#> 
...
#> ✔ Fitting 200 bootstrap replicates (pca, k = 1-5)... [1.8s]
#> 
