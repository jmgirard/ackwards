...
Post-fix re-verification on 05e645b: AC3 sweep clean, code guard clean, test file 88 expectations with 0 failures, document() no diff, gate exit 0 (check 0/0/0, coverage 100.00%, styler, lintr, pkgdown), README double build changed 8 `#>` lines then 0 with `man/figures/` untouched.
