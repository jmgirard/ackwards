...
_Last hygiene check: 2026-07-23 (M75 planned; M74 merged + archived; M69 row pruned under terminal-row retention)_
...
| M75 | Beautify suggest_k() print output as an aligned criteria table | planned | — | normal | milestones/M75-suggest-k-print-table.md |
