...
_Last hygiene check: 2026-07-16 (candidate triage: 2 M60-rejection rows pruned, ESEM rows merged)_
...
|---|---|---|---|---|---|
| M61 | Enrich suggest_k() docs with verified k-selection citations | review | — | normal | milestones/M61-suggest-k-citations.md |
...
- Wire `forbes2023` into a vignette (worked Forbes AMH example) — actionable: dataset shipped 2026-07-12 (M54); existing `ackwards-forbes.Rmd` covers the method extension only, never uses the dataset — added 2026-07-12 — M54 Out
