...
_Last hygiene check: 2026-07-24 (M77 merged + archived, PR #82; terminal-row retention keeps the 5 most recent done rows — M72 row pruned)_
...
| M78 | Gap-tolerant (skip-level) direct redundancy chains — gated on ChaseCorrPaths semantics | review | — | normal | milestones/M78-skip-level-redundancy-chains.md |
