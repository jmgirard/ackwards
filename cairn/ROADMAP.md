...
|---|---|---|---|---|---|
| M69 | Author + verify the 8 secondary-methods source notes against their shelf PDFs | planned | — | normal | milestones/M69-reference-verification-secondary-sources.md |
