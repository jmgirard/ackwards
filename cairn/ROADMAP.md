...
_Last hygiene check: 2026-07-23 (M71 merged + archived; M67 row pruned under terminal-row retention)_
...
| M73 | Draft the manuscript Introduction with the verified framing + application sources | planned | — | normal | milestones/M73-manuscript-introduction.md |
